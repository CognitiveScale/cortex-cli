        ...
        actions: [
            {
                ...
                base: path.join(path.dirname(require.resolve('@c12e/generator-cortex/generators/skill'))),
                templateFiles: path.join(path.dirname(require.resolve('@c12e/generator-cortex/generators/skill')), '**/*.js.hbs'),
                abortOnFail: true,
