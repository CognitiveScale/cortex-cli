...
program
    ...
    .option('--profile [profile]', 'The profile to use')
    .option('--project [project]', 'The project to use')
    .option('--deployable [true/false]', 'Export only deployable missions', true)
...
program
    ...
    .option('--deploy [true/false]', 'Set missions status Ready To Deploy', true)
    .option('--overwrite [true/false]', 'Overwrite existing deployed missions with the imported one', false)
    .action(withCompatibilityCheck((campaignName, options) => {
        try {
